...
class HuntTableViewController: UITableViewController {
    ...
    //TODO update this to Hunt somehow
    //maybe in storyboard name
    ...
    private func loadSampleHunts() {
        ...
        guard let hunt1 = Hunt(name: "Placeholder Hunt Item", photo: photo1, rating: 4) else {
    ...
    private func saveHunts() {
        //attempts to archive hunts array to Hunt.archive...
    ...
    override func viewDidLoad() {
        ...
        //allow for additional buttons next to back button
